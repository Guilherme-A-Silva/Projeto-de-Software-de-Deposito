...
public class ProdutoControle {
	...
	@PutMapping("/{codigo}") 
	public ResponseEntity<Produto> AtualizarTodosOsValoresPorId(@PathVariable Long codigo, @RequestBody Produto produto){
	...
	public ResponseEntity<Produto> AtualizarQuantidadePorId(@PathVariable Long codigo, Produto produto, 
	...
	public ResponseEntity<Produto> AtualizarNomePorId(@PathVariable Long codigo, Produto produto, @PathVariable String nome){
		if(!produtoRepository.existsById(codigo)) {
			return ResponseEntity.notFound().build();
		}
	...
	public ResponseEntity<Produto> AtualizarDescricaoPorId(@PathVariable Long codigo, Produto produto, @PathVariable String descricao){
		if(!produtoRepository.existsById(codigo)) {
			return ResponseEntity.notFound().build();
		}
	...
	public ResponseEntity<Produto> AtualizarPrecoPorId(@PathVariable Long codigo, Produto produto, @PathVariable Double preco){
		if(!produtoRepository.existsById(codigo)) {
			return ResponseEntity.notFound().build();
		}
